...
var _List = _interopRequireWildcard(require("../List3/List3"));
...
var RenderLists3 = function RenderLists3(props) {
  return _react.default.createElement(_renderer.View, null, props.data.map(function (item) {
