...
/*#__PURE__*/
function (_Component) {
  _inherits(DownloadPDFLink, _Component);

  function DownloadPDFLink() {
    _classCallCheck(this, DownloadPDFLink);

    return _possibleConstructorReturn(this, _getPrototypeOf(DownloadPDFLink).apply(this, arguments));
  }

  _createClass(DownloadPDFLink, [{
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement(_antd.Button, {
        ...
        document: (0, _index.DocumentLayouts)(type, name, data),
        fileName: name + ".pdf"
      }, function (_ref) {
        var blob = _ref.blob,
            url = _ref.url,
