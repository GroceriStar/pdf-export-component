...
var DownloadPDFLink1 =
/*#__PURE__*/
function (_Component) {
  _inherits(DownloadPDFLink1, _Component);

  function DownloadPDFLink1() {
    _classCallCheck(this, DownloadPDFLink1);

    return _possibleConstructorReturn(this, _getPrototypeOf(DownloadPDFLink1).apply(this, arguments));
  }

  _createClass(DownloadPDFLink1, [{
    key: "render",
    value: function render() {
      return _react.default.createElement(_antd.Button, {
        ...
        document: (0, _index.DocumentLayout1)(_styles.default, this.props.name, this.props.data),
  ...
  return DownloadPDFLink1;
}(_react.Component);

var _default = DownloadPDFLink1;
