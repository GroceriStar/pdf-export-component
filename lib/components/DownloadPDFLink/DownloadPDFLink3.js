...
var DownloadPDFLink3 =
/*#__PURE__*/
function (_Component) {
  _inherits(DownloadPDFLink3, _Component);

  function DownloadPDFLink3() {
    _classCallCheck(this, DownloadPDFLink3);

    return _possibleConstructorReturn(this, _getPrototypeOf(DownloadPDFLink3).apply(this, arguments));
  }

  _createClass(DownloadPDFLink3, [{
    key: "render",
    value: function render() {
      return _react.default.createElement(_antd.Button, {
        ...
        document: (0, _index.DocumentLayout3)(_styles.default, this.props.name, this.props.data),
  ...
  return DownloadPDFLink3;
}(_react.Component);

var _default = DownloadPDFLink3;
